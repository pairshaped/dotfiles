    ...
    sh -c "`curl -fsSL https://raw.github.com/pairshaped/dotfiles/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.github.com/pairshaped/dotfiles/master/install.sh`" -s ask
```
